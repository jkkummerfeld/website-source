...
- [LegionTools](https://www.cromalab.net/LegionTools/), an interface for mechanical turk that handles integration with their APIs. Designed particularly for real-time systems. Free.
- [Prodigy](https://prodi.gy/), span classification (e.g. NER), which can also be used to handle other tasks if they are broken down into decisions (e.g. is this syntactic relation correct?). Cost is whatever you pay a crowd provider + $390 for a lifetime license, and $10k for a university-wide lifetime license.
